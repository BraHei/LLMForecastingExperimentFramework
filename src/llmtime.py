#%
# serialize.py
# Originally from: https://github.com/ngruver/llmtime
# License: MIT License (https://github.com/ngruver/llmtime/blob/main/LICENSE)
# 
# This file is adapted from the LLMTime project:
# Gruver et al., "LLMTime: Benchmarking Language Models on Temporal Understanding" (2023)
